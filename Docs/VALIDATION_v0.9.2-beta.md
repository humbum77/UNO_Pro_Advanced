...
```
test_browsing_never_prompts (__main__.RollbackTests.test_browsing_never_prompts) ... ok
test_buttons_and_fill (__main__.RollbackTests.test_buttons_and_fill) ... ok
test_legacy_save_and_standalone_save_as (__main__.RollbackTests.test_legacy_save_and_standalone_save_as) ... ok
test_live_drag_assignment (__main__.RollbackTests.test_live_drag_assignment) ... ok
test_protocol_note_payload (__main__.RollbackTests.test_protocol_note_payload) ... ok
test_scale_migration (__main__.RollbackTests.test_scale_migration) ... ok
test_scales (__main__.RollbackTests.test_scales) ... ok
