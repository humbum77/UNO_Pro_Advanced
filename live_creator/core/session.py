...
class Session:
    ...
    def timing(self,song):
        ...
        for b in song.timeline.blocks:
            ...
            durations.extend([beats*60/song.timeline.tempo]*b.length)
        return durations
    ...
    def toggle(self,now):
        ...
        self.loop_range=a.loop_range;self.loop_state=Loop.ASSIGNED if a.loop_range else Loop.NONE
