...
A standalone read-only protocol research utility is available under `ProtocolLab/`. It captures and compares UNO Synth Pro SysEx without enabling unknown write commands. See `ProtocolLab/README.md`.
